...
$result=mysqli_query($conn,"SELECT * FROM $tbl_name WHERE email='$name'");
...
<body>
	...
	<div class="wrap">
		...
		<div class="span12 well pass1">
			...
			<tr>
				<td><span style="font-weight:bold;font-size:35px;">Profile</span>
			...
			<tr>
				<td>
					...
					<table class="table">
					<tr><td ><b> Name :</b> </td> <td style="text-transform:capitalize;"><?php echo $row['uname']; ?></td></tr>
					...
					<tr><td><b>Marital Status :</b> </td> <td><?php echo $row['marital']; ?></td></tr>
					<tr><td><b>Mobile No :</b> </td> <td><?php echo $row['mobile'];?></td></tr>
